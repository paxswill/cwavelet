...
static const wavelet DAUBECHIES_2_WAVELET = {{.classic = {daubechies_2_wavelet, daubechies_2_scaling}}, false, 2, 2};
static const wavelet DAUBECHIES_4_WAVELET = {{.classic = {daubechies_4_wavelet, daubechies_4_scaling}}, false, 2, 4};
static const wavelet DAUBECHIES_6_WAVELET = {{.classic = {daubechies_6_wavelet, daubechies_6_scaling}}, false, 2, 6};
static const wavelet DAUBECHIES_8_WAVELET = {{.classic = {daubechies_8_wavelet, daubechies_8_scaling}}, false, 2, 8};
static const wavelet DAUBECHIES_10_WAVELET = {{.classic = {daubechies_10_wavelet, daubechies_10_scaling}}, false, 2, 10};
